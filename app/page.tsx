...
import { Github, Star, GitPullRequest, BarChart3, Clock, Tag, ArrowRight, Check } from 'lucide-react'
    ...
    <div className="flex min-h-screen flex-col items-center">
      ...
      <main className="flex-1 w-full px-4 md:px-6">
        ...
        <section id="features" className="w-full py-12 md:py-24 bg-muted/50">
          <div className="flex flex-col items-center justify-center space-y-4 text-center w-full mx-auto px-4 md:px-6">
            <div className="space-y-2">
        ...
        <section id="how-it-works" className="w-full py-12 md:py-24">
          <div className="flex flex-col items-center justify-center space-y-4 text-center w-full mx-auto px-4 md:px-6">
            ...
            <div className="mx-auto grid items-center gap-6 py-12 md:grid-cols-3">
              <div className="flex flex-col items-center space-y-2 rounded-lg border p-6 shadow-sm">
