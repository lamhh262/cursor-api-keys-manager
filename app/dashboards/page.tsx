    ...
    <div className="flex min-h-screen bg-gray-50 dark:bg-gray-900">
                  ...
                  <tbody>
                    {apiKeys.map((key) => (
                      <tr key={key.id} className="border-b border-gray-100 dark:border-gray-700">
                        ...
                        <td className="py-4 text-sm text-gray-500">{key.usage || 0}</td>
                        <td className="py-4">
      ...
      {showEditModal && (
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center p-4">
          <div className="bg-white dark:bg-gray-800 rounded-lg max-w-xl w-full p-6">
            <div className="mb-6">
              <h3 className="text-xl font-semibold">Edit API Key Name</h3>
              <p className="text-sm text-gray-500 mt-1">Update the name for this API key.</p>
            </div>
